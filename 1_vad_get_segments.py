...
from peterssecrets import hftoken
def run(audio: Path, output: Path,
    ...
    pipeline = Pipeline.from_pretrained("pyannote/voice-activity-detection", use_auth_token=hftoken).to(torch.device("cuda"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='/home/peterr/.cache/torch/pyannote/models--pyannote--segmentation/snapshots/059e96f964841d40f1a5e755bb7223f76666bba4/pytorch_model.bin', help='Path or hub URL to model file')
